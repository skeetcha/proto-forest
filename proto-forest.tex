...
\end{center}
\begin{multicols}{2}
\begin{ogham} a \end{ogham} \textit{ a} /\textipa{@\textsubarch{i}}/ \textit{n.} Life, a person's being. Also refers to a period of time from birth to death. \textit{num.} Fourteen.

\begin{ogham} abh \end{ogham} \textit{ abh} /\textipa{@\textsubarch{i}v\super{G}}/ \textit{num.} Fifteen.

\begin{ogham} ad \end{ogham} \textit{ ad} /\textipa{@\textsubarch{i}\textsubbridge{d}\super{G}}/ \textit{v.} Improve, to bring into a more desirable or excellent condition.

\begin{ogham} áigilea \end{ogham} \textit{ áigilea} /\textipa{A:I{\textbardotlessj}Il\super{j}a}/ \textit{n.} Insurance, coverage by contract in which one party agrees to indemnify or reimburse another for loss that occurs under the terms of the contract.

\begin{ogham} ainsear \end{ogham} \textit{ ainsear} /\textipa{@\textsubarch{i}\textsubbridge{n}\super{G}SaR\super{G}}/ \textit{n.} Heat, a relatively high degree of warmth.

\begin{ogham} aisea \end{ogham} \textit{ aisea} /\textipa{@\textsubarch{u}Sa}/ \textit{n.} Sailor, a person whose occupation is sailing or navigation; mariner.
\end{multicols}
\end{document}